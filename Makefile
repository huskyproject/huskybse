...
.PHONY: do_not_run_update_as_root \
        ...
        fidoconf_update fidoconf_glue fidoconf_get_date \
        areafix_glue areafix_get_date hptzip_glue hptzip_get_date \
        hpt_update hpt_glue hpt_get_date htick_update htick_glue htick_get_date \
        hptkill_update hptkill_glue hptkill_get_date \
        hptsqfix_update hptsqfix_glue hptsqfix_get_date \
        sqpack_update sqpack_glue sqpack_get_date \
        msged_update msged_glue msged_get_date \
